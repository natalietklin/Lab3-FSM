...
VL_ATTR_COLD void Vlightgen___024root__trace_init_sub__TOP__0(Vlightgen___024root* vlSelf, VerilatedVcd* tracep) {
    if (false && vlSelf) {}  // Prevent unused
    Vlightgen__Syms* const __restrict vlSymsp VL_ATTR_UNUSED = vlSelf->vlSymsp;
    VL_DEBUG_IF(VL_DBG_MSGF("+    Vlightgen___024root__trace_init_sub__TOP__0\n"); );
    // Init
    ...
    tracep->pushNamePrefix("lightgen ");
    tracep->declBit(c+1,"clk", false,-1);
    tracep->declBit(c+2,"rst", false,-1);
    tracep->declBit(c+3,"en", false,-1);
    tracep->declBus(c+4,"N", false,-1, 15,0);
    tracep->declBus(c+5,"data_out", false,-1, 7,0);
    tracep->declBit(c+6,"delay", false,-1);
...
VL_ATTR_COLD void Vlightgen___024root__trace_init_top(Vlightgen___024root* vlSelf, VerilatedVcd* tracep) {
    if (false && vlSelf) {}  // Prevent unused
    Vlightgen__Syms* const __restrict vlSymsp VL_ATTR_UNUSED = vlSelf->vlSymsp;
    VL_DEBUG_IF(VL_DBG_MSGF("+    Vlightgen___024root__trace_init_top\n"); );
    // Body
    Vlightgen___024root__trace_init_sub__TOP__0(vlSelf, tracep);
}

VL_ATTR_COLD void Vlightgen___024root__trace_full_top_0(void* voidSelf, VerilatedVcd::Buffer* bufp);
...
VL_ATTR_COLD void Vlightgen___024root__trace_register(Vlightgen___024root* vlSelf, VerilatedVcd* tracep) {
    if (false && vlSelf) {}  // Prevent unused
    Vlightgen__Syms* const __restrict vlSymsp VL_ATTR_UNUSED = vlSelf->vlSymsp;
    VL_DEBUG_IF(VL_DBG_MSGF("+    Vlightgen___024root__trace_register\n"); );
    // Body
    tracep->addFullCb(&Vlightgen___024root__trace_full_top_0, vlSelf);
    tracep->addChgCb(&Vlightgen___024root__trace_chg_top_0, vlSelf);
    tracep->addCleanupCb(&Vlightgen___024root__trace_cleanup, vlSelf);
}

VL_ATTR_COLD void Vlightgen___024root__trace_full_sub_0(Vlightgen___024root* vlSelf, VerilatedVcd::Buffer* bufp);

VL_ATTR_COLD void Vlightgen___024root__trace_full_top_0(void* voidSelf, VerilatedVcd::Buffer* bufp) {
    VL_DEBUG_IF(VL_DBG_MSGF("+    Vlightgen___024root__trace_full_top_0\n"); );
    // Init
    Vlightgen___024root* const __restrict vlSelf VL_ATTR_UNUSED = static_cast<Vlightgen___024root*>(voidSelf);
    Vlightgen__Syms* const __restrict vlSymsp VL_ATTR_UNUSED = vlSelf->vlSymsp;
    // Body
    Vlightgen___024root__trace_full_sub_0((&vlSymsp->TOP), bufp);
}

VL_ATTR_COLD void Vlightgen___024root__trace_full_sub_0(Vlightgen___024root* vlSelf, VerilatedVcd::Buffer* bufp) {
    if (false && vlSelf) {}  // Prevent unused
    Vlightgen__Syms* const __restrict vlSymsp VL_ATTR_UNUSED = vlSelf->vlSymsp;
    VL_DEBUG_IF(VL_DBG_MSGF("+    Vlightgen___024root__trace_full_sub_0\n"); );
    // Init
    ...
    bufp->fullBit(oldp+6,(vlSelf->lightgen__DOT__delay));
    bufp->fullSData(oldp+7,(vlSelf->lightgen__DOT__ClkTick__DOT__count),16);
    bufp->fullIData(oldp+8,(vlSelf->lightgen__DOT__FSM__DOT__current_state),32);
    bufp->fullIData(oldp+9,((((((((((0U == vlSelf->lightgen__DOT__FSM__DOT__current_state) 
